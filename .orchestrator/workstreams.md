...
| W4 | Estimation and diagnostics | flagship analysis scripts under `analysis/`, analysis-facing execution notes under `qc/` | public authority surfaces, `contracts/`, canonical freeze builders, canonical derived-table builders | rewritten estimand scripts, diagnostic summaries, analysis notes | no | no |
