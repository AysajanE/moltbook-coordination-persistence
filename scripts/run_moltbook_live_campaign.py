...
COLLECT_SCRIPT = Path("analysis/moltbook_api_collect.py")
CURATE_SCRIPT = Path("analysis/moltbook_api_curate.py")
...
def main() -> None:
    ...
    campaign_root = (args.ops_root / CAMPAIGN_RELATIVE / campaign_id).resolve()
